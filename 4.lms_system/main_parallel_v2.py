...
def collect_ad(ad_number):
    main_url = 'https://www.unegui.mn/l-hdlh/l-hdlh-zarna/oron-suuts-zarna/'
...
results = Parallel(n_jobs=-1)(delayed(collect_ad)(n) for n in ad_list)
# Save to dataframe
df = pd.DataFrame(results)  
# Save to csv
df.to_csv('4_Webscraping/unegui_ads.csv', index=False, encoding='utf-8-sig') 