...
st.set_page_config(page_title="Car analysis!!!", page_icon=":bar_chart:",layout="wide")

st.title(" :bar_chart: Loan analysis")
st.markdown('<style>div.block-container{padding-top:2rem;}</style>',unsafe_allow_html=True)

main_path = '3.unegui/data/append/'
df = pd.read_excel(main_path + '2025_3_4.xlsx')
...
df_out = df.groupby('Month')['price'].sum().reset_index()

# outstanding loan monthly
fig = px.line(df_out, x="Month", y="price",
