...
# Load the data
main_path = 'input/' # Ашиглах Цөөн хэдэн баганыг import хийв.
df1 = pd.read_excel(main_path + 'serg2023_01_imp.xlsx', usecols=['Регистр','Бараа код',"Огноо", 'Тээв.х.дугаар', 'Тээврийн төрөл','Нэр', 'Чингэлэг' ,'Илгээгч',"Мэдүүлэгч",'гадаад нэр','Нэгж','Тоо','ГХН'], engine="openpyxl")
df2 = pd.read_excel(main_path + 'serg2023_02_imp.xlsx', usecols=['Регистр','Бараа код',"Огноо", 'Тээв.х.дугаар', 'Тээврийн төрөл','Нэр', 'Чингэлэг' ,'Илгээгч',"Мэдүүлэгч",'гадаад нэр','Нэгж','Тоо','ГХН'], engine="openpyxl")
df3 = pd.read_excel(main_path + 'serg2023_03_imp.xlsx', usecols=['Регистр','Бараа код',"Огноо", 'Тээв.х.дугаар', 'Тээврийн төрөл','Нэр', 'Чингэлэг' ,'Илгээгч',"Мэдүүлэгч",'гадаад нэр','Нэгж','Тоо','ГХН'], engine="openpyxl")
df4 = pd.read_excel(main_path + 'serg2023_04_imp.xlsx', usecols=['Регистр','Бараа код',"Огноо", 'Тээв.х.дугаар', 'Тээврийн төрөл','Нэр', 'Чингэлэг' ,'Илгээгч',"Мэдүүлэгч",'гадаад нэр','Нэгж','Тоо','ГХН'], engine="openpyxl")
df5 = pd.read_excel(main_path + 'serg2023_05_imp.xlsx', usecols=['Регистр','Бараа код',"Огноо", 'Тээв.х.дугаар', 'Тээврийн төрөл','Нэр', 'Чингэлэг' ,'Илгээгч',"Мэдүүлэгч",'гадаад нэр','Нэгж','Тоо','ГХН'], engine="openpyxl")
df6 = pd.read_excel(main_path + 'serg2023_06_imp.xlsx', usecols=['Регистр','Бараа код',"Огноо", 'Тээв.х.дугаар', 'Тээврийн төрөл','Нэр', 'Чингэлэг' ,'Илгээгч',"Мэдүүлэгч",'гадаад нэр','Нэгж','Тоо','ГХН'], engine="openpyxl")
df7 = pd.read_excel(main_path + 'serg2023_09_imp.xlsx', usecols=['Регистр','Бараа код',"Огноо", 'Тээв.х.дугаар', 'Тээврийн төрөл','Нэр', 'Чингэлэг' ,'Илгээгч',"Мэдүүлэгч",'гадаад нэр','Нэгж','Тоо','ГХН'], engine="openpyxl")
df8 = pd.read_excel(main_path + 'serg2023_10_imp.xlsx', usecols=['Регистр','Бараа код',"Огноо", 'Тээв.х.дугаар', 'Тээврийн төрөл','Нэр', 'Чингэлэг' ,'Илгээгч',"Мэдүүлэгч",'гадаад нэр','Нэгж','Тоо','ГХН'], engine="openpyxl")
df9 = pd.read_excel(main_path + 'serg2023_11_1imp.xlsx', usecols=['Регистр','Бараа код',"Огноо", 'Тээв.х.дугаар', 'Тээврийн төрөл','Нэр', 'Чингэлэг' ,'Илгээгч',"Мэдүүлэгч",'гадаад нэр','Нэгж','Тоо','ГХН'], engine="openpyxl")
df10 = pd.read_excel(main_path + 'serg2023_12_imp.xlsx', usecols=['Регистр','Бараа код',"Огноо", 'Тээв.х.дугаар', 'Тээврийн төрөл','Нэр', 'Чингэлэг' ,'Илгээгч',"Мэдүүлэгч",'гадаад нэр','Нэгж','Тоо','ГХН'], engine="openpyxl")
df11 = pd.read_excel(main_path + 'serg_imp07_1.xlsx', usecols=['Регистр','Бараа код',"Огноо", 'Тээв.х.дугаар', 'Тээврийн төрөл','Нэр', 'Чингэлэг' ,'Илгээгч',"Мэдүүлэгч",'гадаад нэр','Нэгж','Тоо','ГХН'], engine="openpyxl")
df12 = pd.read_excel(main_path + 'serg_imp07_2.xlsx', usecols=['Регистр','Бараа код',"Огноо", 'Тээв.х.дугаар', 'Тээврийн төрөл','Нэр', 'Чингэлэг' ,'Илгээгч',"Мэдүүлэгч",'гадаад нэр','Нэгж','Тоо','ГХН'], engine="openpyxl")
df13 = pd.read_excel(main_path + 'serg_imp07_3.xlsx', usecols=['Регистр','Бараа код',"Огноо", 'Тээв.х.дугаар', 'Тээврийн төрөл','Нэр', 'Чингэлэг' ,'Илгээгч',"Мэдүүлэгч",'гадаад нэр','Нэгж','Тоо','ГХН'], engine="openpyxl")
df14 = pd.read_excel(main_path + 'serg_imp08_1.xlsx', usecols=['Регистр','Бараа код',"Огноо", 'Тээв.х.дугаар', 'Тээврийн төрөл','Нэр', 'Чингэлэг' ,'Илгээгч',"Мэдүүлэгч",'гадаад нэр','Нэгж','Тоо','ГХН'], engine="openpyxl")
df15 = pd.read_excel(main_path + 'serg_imp08_2.xlsx', usecols=['Регистр','Бараа код',"Огноо", 'Тээв.х.дугаар', 'Тээврийн төрөл','Нэр', 'Чингэлэг' ,'Илгээгч',"Мэдүүлэгч",'гадаад нэр','Нэгж','Тоо','ГХН'], engine="openpyxl")
df16 = pd.read_excel(main_path + 'serg_imp08_3.xlsx', usecols=['Регистр','Бараа код',"Огноо", 'Тээв.х.дугаар', 'Тээврийн төрөл','Нэр', 'Чингэлэг' ,'Илгээгч',"Мэдүүлэгч",'гадаад нэр','Нэгж','Тоо','ГХН'], engine="openpyxl")
...
df_cleaned_1 = df_cleaned_1[df_cleaned_1['Тээврийн төрөл'] != 'Хөдөлтгөөнт бус тээвэр']
df_cleaned_1 = df_cleaned_1[df_cleaned_1['Тээврийн төрөл'] != 'Бусад тээврийн хэрэгсэл']
df_cleaned_1 = df_cleaned_1[df_cleaned_1['Тээврийн төрөл'] != 'Шуудан илгээмж']
df_cleaned_1 = df_cleaned_1[df_cleaned_1['Тээврийн төрөл'] != 'Холимог тээвэр']

# Export хийх датаг багасгав

filtered_df = df_cleaned_1[df_cleaned_1['Тээврийн төрөл'] == "Холимог тээвэр"]
filtered_df.to_excel("output_file3.xlsx", index=False)

df_last = df_cleaned_1.loc[:, ['date_column','Регистр','Нэр','Хувь/Байгууллага','Тээврийн төрөл_2',"Мэдүүлэгч","Илгээгч",'Автомашин эсэх','гадаад нэр','Нэгж','Тоо','ГХН']]


# excel export
df_last.to_excel("output_file2.xlsx", index=False)
